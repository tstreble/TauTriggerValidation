...
goodMuons = cms.EDFilter("PATMuonRefSelector",
        ...
        cut = cms.string(
                ...
                '&& ( (pfIsolationR03().sumChargedHadronPt + max(pfIsolationR03().sumNeutralHadronEt + pfIsolationR03().sumPhotonEt - 0.5 * pfIsolationR03().sumPUPt, 0.0)) / pt() ) < 0.15 ' # isolation
...
goodTaus = cms.EDFilter("PATTauRefSelector",
        ...
        cut = cms.string(
                ...
                '&& tauID("byCombinedIsolationDeltaBetaCorrRaw3Hits") < 2.0 ' # tau iso - NOTE: can as well use boolean discriminators with WP
