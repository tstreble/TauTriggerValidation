...
TriggerSelection = {
#     'L1'   : ' l2_L1_type == 7 & l2_L1_bx == 0 & l2_L1_pt > 19.5',
    'HLT'  : ' probe & l2_trig_obj_pt > 0'                       ,
}

filenames = [
    '../../2016Bv4_HLT_IsoMu19_eta2p1_LooseIsoPFTau20/SingleMuon_Run2016B_PromptReco_v1/H2TauTauTreeProducerTauMu/tree.root',
    '../../2016Bv4_HLT_IsoMu19_eta2p1_LooseIsoPFTau20/SingleMuon_Run2016B_PromptReco_v2/H2TauTauTreeProducerTauMu/tree.root',    
]
...
HLTPlotter = Plotter(variables     = variables                         , 
                     out_filename  = 'mu_tau_crossL1_plots_ss.root'       , 
