...
#     'L2p5' : ' l2_L1_type == 7 & l2_L1_bx == 0 & l2_L1_iso == 1 & l2_L1_pt > 27.5 & l2_hltL2IsoTau26eta2p2_pt > 0',
    #'HLT'  : ' l2_L1_type == 7 & l2_L1_bx == 0 & l2_L1_iso == 1 & l2_L1_pt > 27.5 & probe & l2_trig_obj_pt > 35'   ,
      'HLT': 'l1IsoMatched==1 & l1tauPt > 30',
}

filenames = [
   '/data/uhussain/TauTrigVal_2016/CMSSW_8_0_5/src/TauTriggerValidation/TauTriggerValidation/test/NTuple_SingleMuon2016B_v1.root',
   '/data/uhussain/TauTrigVal_2016/CMSSW_8_0_5/src/TauTriggerValidation/TauTriggerValidation/test/NTuple_SingleMuon2016B_v2.root',]
...
t1 = ROOT.TChain('Ntuplizer/TagAndProbe;1')
...
#     Efficiency1D(tree=t1, name='npv'    , variable='n_vertices', histo_name='npv'    , cut_num='1', cut_den='1', xlabel='# PV'              , ylabel='L1 + HLT #tau efficiency', bins=10   , bini= 0    , bine=  30   ),
    Efficiency1D(tree=t1, name='tau_pt' , variable='tauPt'     , histo_name='tau_pt' , cut_num='1', cut_den='1', xlabel='offline #tau p_{T}', ylabel='L1 + HLT #tau efficiency', bins=bins ,                         ),
...
HLTPlotter = Plotter(variables     = variables                         , 
                     out_filename  = 'diTau_plots_test.root'     , 
